...
Assert-True ($SourceText.Contains("screen_space_brush_query_v1")) "screen-space brush query side backend marker is missing"
Assert-True ($SourceText.Contains("side_backend")) "side backend status marker is missing"
